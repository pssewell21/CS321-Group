...
public class ATMUI extends JFrame {
    ...
    private JComboBox<String> jComboBox_openac_actype = null;
    ...
    private JComboBox<String> jComboBox2 = null;

    private JComboBox<String> jComboBox3 = null;

    private JComboBox<String> jComboBox4 = null;

    private JComboBox<String> jComboBox5 = null;

    private JComboBox<String> jComboBox6 = null;

    private JLabel jLabel18 = null;

    private JLabel jLabel19 = null;

    private JList<String> jList_inquirytrade = null;
...
//			}
    ...
    private JComboBox getJComboBox_openac_actype() {
        if (jComboBox_openac_actype == null) {
            ...
            jComboBox_openac_actype.addItem("Checking");
            ...
            jButton_openac_btn.addActionListener(new java.awt.event.ActionListener() {
                ...
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    ...
                    try {
                        ...
                        if (jComboBox_openac_actype.getSelectedItem().equals("Checking")) {
                            accounttype = false;
                        }
            ...
            jButton.addActionListener(new java.awt.event.ActionListener() {
                ...
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    try {
                        ...
                        } else if (command.equals("1y")) {
                            startday.roll(Calendar.DATE, -7);
                        } else if (command.equals("1m")) {
